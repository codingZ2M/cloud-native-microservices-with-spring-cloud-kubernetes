...
import com.codingz2m.savingsaccountservice.util.AppUtils;
...
public class SavingsAccountServiceImpl implements SavingsAccountService {
	...
	public SavingsAccount update(SavingsAccountDto savingsAccountDto) throws SavingsAccountNotFoundException {
		...
		Optional<SavingsAccount> optionalSavingsAccount  = savingsAccountRepository.findById(savingsAccount.getSavingsAccountId());
		
		if ( !optionalSavingsAccount.isPresent() ) {
			throw new SavingsAccountNotFoundException("SavingsAccount ID: " + savingsAccount.getSavingsAccountId() + " Not Found to Update");
		}
		else {
		...
		existingSavingsAccount.setAnnualPercentageYield(savingsAccount.getAnnualPercentageYield());
		existingSavingsAccount.setMinimumBalanceToAvailAPY(savingsAccount.getMinimumBalanceToAvailAPY());
		existingSavingsAccount.setMinimumBalanceToOpenAccount(savingsAccount.getMinimumBalanceToOpenAccount());
		existingSavingsAccount.setCurrentValue(savingsAccount.getCurrentValue());
		existingSavingsAccount.setCards(savingsAccount.getCards());
		existingSavingsAccount.setContact(savingsAccount.getContact());
